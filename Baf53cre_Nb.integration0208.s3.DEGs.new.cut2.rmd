...
```{r}
neur.ol <- c("IPAN1","IPAN1.1","IPAN1.2","IPAN2","IPAN2.1")
neur.ol
```
...
xx=neur.ol[5]
  ...
  pdf(paste0("./figures.integration/DEGs.new/overlap.cut2/overlap.cut2.",xx,".pdf"),
      width = 9, height = 5)
  upset(fromList(c(test1_up.list[[xx]],
                   test2_up.list[[xx]])),
      order.by = 'freq', nsets = 6, point.size=3.5, line.size =1, text.scale = 2)
...
for(NN in c("IPAN1","IPAN1.1","IPAN1.2","IPAN2","IPAN2.1")){
...
for(NN in c("IPAN1","IPAN1.1","IPAN1.2","IPAN2","IPAN2.1")){
  for(XX in c("INFxCTL","PBSxCKO")){
    write.table(test3_up.list[[XX]][[NN]], paste0("./figures.integration/DEGs.new/overlap.list.cut2/overlap.cut2.",NN,"_",XX,".txt"), row.names = F, col.names = F, quote = F)
  }
}
...
GEX.seur <- add_geneset_score(obj = GEX.seur,
                              ...
                              setname = "cut2.score.IPAN1_PBSup")
GEX.seur <- add_geneset_score(obj = GEX.seur,
                              Assay = "SCT",
                              geneset = test1_up.list$IPAN1$Nb5d.INF,
                              setname = "cut2.score.IPAN1_INFup")
GEX.seur <- add_geneset_score(obj = GEX.seur,
                              Assay = "SCT",
                              geneset = test2_up.list$IPAN1$Nb5d.CTL,
                              setname = "cut2.score.IPAN1_CTLup")
GEX.seur <- add_geneset_score(obj = GEX.seur,
                              Assay = "SCT",
                              geneset = test2_up.list$IPAN1$Nb5d.CKO,
                              setname = "cut2.score.IPAN1_CKOup")
```
...
GEX.seur <- add_geneset_score(obj = GEX.seur,
                              ...
                              setname = "cut2.score.IPAN2_PBSup")
GEX.seur <- add_geneset_score(obj = GEX.seur,
                              Assay = "SCT",
                              geneset = test1_up.list$IPAN2$Nb5d.INF,
                              setname = "cut2.score.IPAN2_INFup")
GEX.seur <- add_geneset_score(obj = GEX.seur,
                              Assay = "SCT",
                              geneset = test2_up.list$IPAN2$Nb5d.CTL,
                              setname = "cut2.score.IPAN2_CTLup")
GEX.seur <- add_geneset_score(obj = GEX.seur,
                              Assay = "SCT",
                              geneset = test2_up.list$IPAN2$Nb5d.CKO,
                              setname = "cut2.score.IPAN2_CKOup")
```
...
vln.DEGs_IPAN1[["PBSvsINF"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.PBS_INF" & intAnno1 %in% c("IPAN1")), 
                                             features = paste0("cut2.score.",x), group.by = "cnt", cols = color.test1, pt.size = 0) +
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN1 only") &
    ...
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.1,1.05)) &  
...
vln.DEGs_IPAN1[["PBSvsINF"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.PBS_INF" & intAnno1 %in% c("IPAN1")), 
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN1 only") &
    geom_boxplot(outlier.size = 0, fill="white", width=0.2, size=0.1, alpha=0.55) &
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.2,1.45)) &  
  ggpubr::stat_compare_means(aes(lable = ..p.signif..), 
                               method = "wilcox.test",
                               comparisons = list(c("Nb5d.PBS","Nb5d.INF")),
                               label.y = c(1.25),
...
vln.DEGs_IPAN1[["CTLvsCKO"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.CTL_CKO" & intAnno1 %in% c("IPAN1")), 
                                             features = paste0("cut2.score.",x), group.by = "cnt", cols = color.test2, pt.size = 0) +
...
vln.DEGs_IPAN1[["CTLvsCKO"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.CTL_CKO" & intAnno1 %in% c("IPAN1")), 
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN1 only") &
    geom_boxplot(outlier.size = 0, fill="white", width=0.2, size=0.1, alpha=0.55) &
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.15,1.55)) &  
  ggpubr::stat_compare_means(aes(lable = ..p.signif..), 
                               method = "wilcox.test",
                               comparisons = list(c("Nb5d.CTL","Nb5d.CKO")),
                               label.y = c(1.4),
...
# 
pdf("./figures.integration/DEGs.new/sig.DEGs.cut2/vln.PBSvsINF.DEGcut2.scoreIPAN1.IPAN1only.pdf",
       width = 5, height = 8)
cowplot::plot_grid(plotlist = vln.DEGs_IPAN1$PBSvsINF, ncol = 2)
dev.off()

# 
pdf("./figures.integration/DEGs.new/sig.DEGs.cut2/vln.CTLvsCKO.DEGcut2.scoreIPAN1.IPAN1only.pdf",
       width = 5, height = 8)
...
vln.DEGs_IPAN2[["PBSvsINF"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.PBS_INF" & intAnno1 %in% c("IPAN2")), 
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN2 only") &
    geom_boxplot(outlier.size = 0, fill="white", width=0.2, size=0.1, alpha=0.55) &
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.3,1.3)) &  
  ggpubr::stat_compare_means(aes(lable = ..p.signif..), 
                               method = "wilcox.test",
                               comparisons = list(c("Nb5d.PBS","Nb5d.INF")),
                               label.y = c(1.18),
...
vln.DEGs_IPAN2[["PBSvsINF"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.PBS_INF" & intAnno1 %in% c("IPAN2")), 
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN2 only") &
    geom_boxplot(outlier.size = 0, fill="white", width=0.2, size=0.1, alpha=0.55) &
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.15,0.8)) &  
  ggpubr::stat_compare_means(aes(lable = ..p.signif..), 
                               method = "wilcox.test",
                               comparisons = list(c("Nb5d.PBS","Nb5d.INF")),
                               label.y = c(0.7),
...
vln.DEGs_IPAN2[["PBSvsINF"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.PBS_INF" & intAnno1 %in% c("IPAN2")), 
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN2 only") &
    geom_boxplot(outlier.size = 0, fill="white", width=0.2, size=0.1, alpha=0.55) &
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.15,1)) &  
  ggpubr::stat_compare_means(aes(lable = ..p.signif..), 
                               method = "wilcox.test",
                               comparisons = list(c("Nb5d.PBS","Nb5d.INF")),
                               label.y = c(0.85),
...
vln.DEGs_IPAN2[["PBSvsINF"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.PBS_INF" & intAnno1 %in% c("IPAN2")), 
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN2 only") &
    geom_boxplot(outlier.size = 0, fill="white", width=0.2, size=0.1, alpha=0.55) &
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.56,1.65)) &  
  ggpubr::stat_compare_means(aes(lable = ..p.signif..), 
                               method = "wilcox.test",
                               comparisons = list(c("Nb5d.PBS","Nb5d.INF")),
                               label.y = c(1.52),
...
vln.DEGs_IPAN2[["CTLvsCKO"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.CTL_CKO" & intAnno1 %in% c("IPAN2")), 
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN2 only") &
    geom_boxplot(outlier.size = 0, fill="white", width=0.2, size=0.1, alpha=0.55) &
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.3,1.15)) &  
  ggpubr::stat_compare_means(aes(lable = ..p.signif..), 
                               method = "wilcox.test",
                               comparisons = list(c("Nb5d.CTL","Nb5d.CKO")),
                               label.y = c(1),
...
vln.DEGs_IPAN2[["CTLvsCKO"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.CTL_CKO" & intAnno1 %in% c("IPAN2")), 
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN2 only") &
    geom_boxplot(outlier.size = 0, fill="white", width=0.2, size=0.1, alpha=0.55) &
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.15,0.81)) &  
  ggpubr::stat_compare_means(aes(lable = ..p.signif..), 
                               method = "wilcox.test",
                               comparisons = list(c("Nb5d.CTL","Nb5d.CKO")),
                               label.y = c(0.75),
...
vln.DEGs_IPAN2[["CTLvsCKO"]][[x]] <- VlnPlot(subset(GEX.seur, subset= orig.ident == "Nb5d.CTL_CKO" & intAnno1 %in% c("IPAN2")), 
  ...
  geom_jitter(alpha=0.2, shape=16, width = 0.2, size = 0.25) & labs(x = "IPAN2 only") &
    geom_boxplot(outlier.size = 0, fill="white", width=0.2, size=0.1, alpha=0.55) &
    stat_summary(fun=mean, geom="point", shape=18, size=3, color="black", alpha=0.55) & coord_cartesian(ylim = c(-0.5,2)) &  
  ggpubr::stat_compare_means(aes(lable = ..p.signif..), 
                               method = "wilcox.test",
                               comparisons = list(c("Nb5d.CTL","Nb5d.CKO")),
                               label.y = c(1.8),
...
```{r eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
# 
pdf("./figures.integration/DEGs.new/sig.DEGs.cut2/vln.PBSvsINF.DEGcut2.scoreIPAN2.IPAN2only.pdf",
       width = 5, height = 8)
cowplot::plot_grid(plotlist = vln.DEGs_IPAN2$PBSvsINF, ncol = 2)
dev.off()

# 
pdf("./figures.integration/DEGs.new/sig.DEGs.cut2/vln.CTLvsCKO.DEGcut2.scoreIPAN2.IPAN2only.pdf",
       width = 5, height = 8)
